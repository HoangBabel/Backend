    ...
    public static class ProductSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category { CategoryId = 1, Name = "Nấu ăn và chế biến thực phẩm" },
            ...
            modelBuilder.Entity<Product>().HasData(
                 ...
                 new Product { IdProduct = 1, CategoryId = 1, Name = "Nồi cơm điện Cuckoo CR-0675F", Price = 1590000m, Quantity = 18, Description = "Nấu cơm nhanh, giữ ấm lâu, dễ vệ sinh.", Image = "/images/giadung1.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 3, CategoryId = 1, Name = "Lò vi sóng Sharp R-G226VN-BK", Price = 1990000m, Quantity = 14, Description = "Hâm, nấu, rã đông nhanh, núm xoay cơ học.", Image = "/images/giadung3.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 5, CategoryId = 1, Name = "Máy pha cà phê Delonghi EC685", Price = 3990000m, Quantity = 10, Description = "Pha espresso chất lượng, thiết kế nhỏ gọn.", Image = "/images/giadung5.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 7, CategoryId = 2, Name = "Tủ đông Electrolux 200 lít EFZ2200H-H", Price = 8990000m, Quantity = 8, Description = "Bảo quản thực phẩm lâu dài, tiết kiệm điện.", Image = "/images/lammat2.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 9, CategoryId = 2, Name = "Máy điều hòa Daikin Inverter 1.5 HP FTKY35WMVMV", Price = 11490000m, Quantity = 9, Description = "Khử khuẩn, tiết kiệm điện vượt trội.", Image = "/images/lammat4.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 // --- Giặt giũ và vệ sinh ---
                 new Product { IdProduct = 11, CategoryId = 3, Name = "Máy giặt Electrolux Inverter 10kg EWF1024BDWA", Price = 8990000m, Quantity = 10, Description = "Công nghệ UltraMix hòa tan bột giặt.", Image = "/images/giatgiu1.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 13, CategoryId = 3, Name = "Robot hút bụi Xiaomi Mi Robot Vacuum", Price = 4990000m, Quantity = 15, Description = "Hút bụi tự động, lập bản đồ thông minh.", Image = "/images/giatgiu3.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 15, CategoryId = 3, Name = "Máy sấy quần áo Electrolux EDV705HQWA", Price = 5990000m, Quantity = 9, Description = "Sấy nhanh, tiết kiệm điện, bảo vệ vải.", Image = "/images/giatgiu5.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 17, CategoryId = 4, Name = "Loa Bluetooth JBL Charge 5", Price = 2590000m, Quantity = 15, Description = "Âm thanh mạnh mẽ, pin 20 giờ.", Image = "/images/giai_tri2.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
                 ...
                 new Product { IdProduct = 19, CategoryId = 4, Name = "Máy chiếu mini ViewSonic M1", Price = 6990000m, Quantity = 7, Description = "Chiếu phim Full HD, pin tích hợp.", Image = "/images/giai_tri4.jpg", Status = ProductStatus.ConHang, IsDeleted = false, IsRental = false, Condition = ProductCondition.New },
